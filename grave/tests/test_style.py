...
def test_generate_node_styles_callable(barbell_network):
    ...
    node_styles = generate_node_styles(barbell_network, style_func)
...
def test_generate_node_styles_dict(barbell_network):
    ...
    node_styles = generate_node_styles(barbell_network, updated)
...
def test_generate_node_style_typerror(barbell_network):
    with pytest.raises(TypeError):
        node_styles = generate_node_styles(barbell_network, "red")
...
def test_generate_edge_styles_callable(barbell_network):
    ...
    edge_styles = generate_edge_styles(barbell_network, style_func)
...
def test_generate_edge_styles_dict(barbell_network):
    ...
    edge_styles = generate_edge_styles(barbell_network, style)
...
def test_generate_edge_style_typerror(barbell_network):
    with pytest.raises(TypeError):
        edge_styles = generate_edge_styles(barbell_network, "red")
...
def test_use_style_attributes_default(style_key, barbell_network):
    ...
    node_styles = generate_node_styles(barbell_network, use_attributes())
...
def test_use_style_attributes_filter_single(barbell_network):
    ...
    node_styles = generate_node_styles(barbell_network, use_attributes("color"))
...
def test_use_style_attributes_filter_list(barbell_network):
    ...
    node_styles = generate_node_styles(
        barbell_network, use_attributes(["color", "shape"])
    )
    expected = default_node_style()
    expected["color"] = "TEST"
    expected["shape"] = "TEST"
